...
public:
    ...
    /**
     * @brief Set modifier key state (CTRL)
     * @param ctrl_pressed True if CTRL key is pressed
     */
    void set_ctrl_pressed(bool ctrl_pressed) { ctrl_pressed_ = ctrl_pressed; }
...
private:
    ...
    bool ctrl_pressed_{false};  // CTRL modifier key state
};
